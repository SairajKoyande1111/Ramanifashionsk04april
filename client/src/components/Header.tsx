        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center justify-end gap-1 md:gap-2 flex-shrink-0">
            ...
            <Button 
              variant="ghost" 
              size="icon" 
              className="h-11 w-11 md:h-12 md:w-12 [&_svg]:!size-5 md:[&_svg]:!size-6"
              onClick={() => {
            ...
            {user ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="h-11 w-11 md:h-12 md:w-12 hover:bg-gray-100 [[&_svg]:!size-8 md:[&_svg]:!size-10_svg]:!size-5 md:[[&_svg]:!size-8 md:[&_svg]:!size-10_svg]:!size-6" data-testid="button-account">
                    <User />
                  </Button>
                </DropdownMenuTrigger>
              ...
              <Button 
                variant="ghost" 
                size="icon" 
                className="h-11 w-11 md:h-12 md:w-12 hover:bg-gray-100 [[&_svg]:!size-8 md:[&_svg]:!size-10_svg]:!size-5 md:[[&_svg]:!size-8 md:[&_svg]:!size-10_svg]:!size-6" 
                onClick={openLogin} 
            ...
            <Button variant="ghost" size="icon" className="relative h-11 w-11 md:h-12 md:w-12 hover:bg-gray-100 [[&_svg]:!size-8 md:[&_svg]:!size-10_svg]:!size-5 md:[[&_svg]:!size-8 md:[&_svg]:!size-10_svg]:!size-6" onClick={() => setLocation("/wishlist")} data-testid="button-wishlist">
              <Heart />
            ...
            <Button variant="ghost" size="icon" className="relative h-11 w-11 md:h-12 md:w-12 hover:bg-gray-100 [[&_svg]:!size-8 md:[&_svg]:!size-10_svg]:!size-5 md:[[&_svg]:!size-8 md:[&_svg]:!size-10_svg]:!size-6" onClick={() => setLocation("/cart")} data-testid="button-bag">
              <ShoppingBag />
              {actualCartCount > 0 && (
                <Badge 
                  className="absolute -top-1 -right-1 h-5 w-5 flex items-center justify-center p-0 text-xs"
